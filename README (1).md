...
| Database | Records | Unique contribution | Records 26-08 | AAR |
|---|---|---|---|---|
| Web of Science Core Collection | 1,433 | 1,431 (2 retracted articles excluded) | 1,828 | 1805|
| Scopus | 1,163 | 361 | 1,045 | 227 |
| PubMed | 918 | 129 | 635 | 31 |
| **Unique tri-database corpus** | **3,514 raw** | **1,921** | **3,508 raw**| **2,086** |

Deduplication priority: WoS > Scopus > PubMed, LA ELIMINACION DE DUPLICADOS SE HIZO CON ZOTERO (11FORMATO NO COINCIDE.12 DUPLICADOS)
